...
if __name__ == '__main__':
    ...
    # Additional options 0.05 0.1 0.2
    ...
    parser.add_argument('--lambda_sparse', type=float, default=0.0, help=" (was 0.05) [optional] adopt from palettenerf, will generate more clear boundary in classification, but may lose some geometry accurate, lambda for sparsity loss was 0.05") 
