...
class Trainer(object):
    ...
    def test(self, loader, save_path=None, name=None, write_video=True, selected_idx=None):
        ...
        os.makedirs(os.path.join(save_path, 'imgs'), exist_ok=True) # for results each frames
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(loader):
                ...
                if write_video:
                    ...
                    cv2.imwrite(os.path.join(save_path,'imgs',f'{name}_{i:04d}_rgb.png'), cv2.cvtColor(pred, cv2.COLOR_RGB2BGR))
                else:
    ...
    def evaluate_one_epoch(self, loader, name=None):
        ...
        with torch.no_grad():
            ...
            for data in loader:    
                ...
                with torch.cuda.amp.autocast(enabled=self.fp16):
                    preds, preds_depth, truths, loss = self.eval_step(data) #* edit this one
